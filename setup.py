# Only installs the cross-eval launcher plugin. Built off example template/code from hydra.
...
with open("readme.md", "r") as fh:
    LONG_DESC = fh.read()
    setup(
        name="hydra-cross-eval-sweeper",
        version="1.0.0",
        author="NYU GIL",
        author_email="smearle93@gmail.com",
        description="Cross-Eval Hydra Sweeper plugin",
